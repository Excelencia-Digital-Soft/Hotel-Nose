    ...
    <Transition name="modal-outer" appear>
      ...
      >
        <Transition name="modal-inner">
          ...
          >
            <!-- Header -->
            <div class="relative p-8 bg-gradient-to-r from-primary-600/20 via-secondary-600/20 to-accent-600/20 border-b border-white/10">
              <button
                type="button"
                @click="$emit('close')"
              ...
              <div class="flex items-center gap-4">
                <div class="w-16 h-16 bg-gradient-to-r from-primary-400 to-secondary-400 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div>
                  ...
                  <p class="text-gray-300 text-sm mt-1">
                    {{ user ? 'Modificar información del usuario' : 'Agregar nuevo usuario al sistema' }}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="p-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
              ...
              >
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        ...
                        class="w-full p-4 pr-12 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300"
                        :class="{ 'border-red-500 focus:ring-red-500': errors.passwordConfirmation }"
                        placeholder="••••••••"
                        autocomplete="new-password"
                      />
                      <button
                        ...
                        class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-white transition-colors duration-300"
                      >
                        <i :class="showPasswordConfirmationField ? 'fas fa-eye-slash' : 'fas fa-eye'"></i>
                      </button>
                    </div>
                    <p v-if="errors.passwordConfirmation" class="text-red-400 text-sm mt-2 flex items-center">
                      <i class="fas fa-exclamation-circle mr-1"></i>{{ errors.passwordConfirmation }}
                    </p>
                  </div>
                </template>
                ...
                <div class="md:col-span-2">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 p-4 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 max-h-40 overflow-y-auto custom-scrollbar">
                    <div
                      v-for="role in roles"
                      :key="role.id"
                    ...
                    >
                      ...
                      />
                      <label :for="`role-${role.id}`" class="text-white text-sm font-medium cursor-pointer flex-1">
                        {{ role.name }}
                ...
                <!-- Status toggle -->
                <div class="md:col-span-2">
                  <div class="flex items-center justify-between p-4 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10">
                    <div class="flex items-center gap-3">
                      <i class="fas fa-toggle-on text-green-400 text-xl"></i>
                      <div>
                        <label for="isActive" class="text-white font-medium cursor-pointer">Estado del Usuario</label>
                        <p class="text-gray-400 text-sm">Determina si el usuario puede acceder al sistema</p>
                      </div>
                    </div>
                ...
                <div v-if="apiError" class="md:col-span-2">
                  <div class="p-4 rounded-2xl bg-red-500/10 border border-red-500/20 backdrop-blur-md">
                    <div class="flex items-center gap-3">
...
watch(() => form.value.passwordConfirmation, () => {
