<template>
  <Teleport to="body" class="overflow-hidden">
    <Transition name="modal-outer" appear>
      <div class="fixed w-full h-full overflow-auto z-20 bg-black bg-opacity-30 top-0 left-0 flex justify-center px-8">
        <Transition name="modal-inner">
          <div
            class=" w-4/6 h-auto bg-surface-900 fixed top-20 flex flex-col justify-evenly items-start p-8 pb-12 rounded-3xl self-start mt-16  border-8 border-purple-300/75 ">
            ...
            <div class="container mx-auto">
              ...
              <div style="max-height: 50vh; overflow-y: auto;">
                ...
                <!-- TABLE CONTENT -->
                <TableRow :selectedList="seleccionados" @update:productList="actualizarSeleccionados"></TableRow>
