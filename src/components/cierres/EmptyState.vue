  ...
  <div class="flex flex-col items-center justify-center py-16 px-6">
    ...
    <div class="relative mb-8">
      ...
      <div class="glass-card p-12 relative overflow-hidden">
        ...
        <div
          class="absolute inset-0 bg-gradient-to-br from-primary-400/5 to-secondary-400/5 animate-pulse"
        ></div>

        <!-- Main icon -->
        <div class="relative z-10 flex items-center justify-center">
          <div
            class="bg-gradient-to-br from-neutral-600 to-neutral-700 p-6 rounded-full shadow-2xl"
          >
        ...
        <div
          class="absolute top-4 right-4 w-4 h-4 bg-primary-400/30 rounded-full animate-float-slow"
        ></div>
        <div
          class="absolute bottom-6 left-6 w-3 h-3 bg-secondary-400/30 rounded-full animate-float-slower"
        ></div>
        <div
          class="absolute top-1/2 left-4 w-2 h-2 bg-accent-400/30 rounded-full animate-float-fast"
        ></div>
      </div>
    </div>
    ...
    <div class="text-center space-y-4 max-w-md">
      <h3 class="text-2xl font-bold text-white mb-2">📭 No hay cierres disponibles</h3>
      <p class="text-gray-300 text-lg leading-relaxed">
        Aún no se han registrado cierres de caja en el sistema. Los cierres aparecerán aquí una vez
    ...
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
      <div
        class="absolute top-1/4 left-1/4 w-32 h-32 bg-primary-400/5 rounded-full animate-pulse"
      ></div>
      <div
        class="absolute bottom-1/3 right-1/4 w-24 h-24 bg-secondary-400/5 rounded-full animate-pulse"
        style="animation-delay: 1s"
      ></div>
      <div
        class="absolute top-1/2 right-1/3 w-16 h-16 bg-accent-400/5 rounded-full animate-pulse"
