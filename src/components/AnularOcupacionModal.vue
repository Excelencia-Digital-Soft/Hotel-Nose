<template>
  <Teleport to="body">
    ...
    >
      <div v-if="visible" class="fixed inset-0 bg-black/60 backdrop-blur-xl z-50 flex items-center justify-center p-4">
        <Transition
          enter-active-class="transition-all duration-300 ease-out"
        ...
        >
          <div v-if="visible" class="bg-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 w-full max-w-md relative overflow-hidden">
            <!-- Background glow effect -->
            <div class="absolute w-96 h-96 bg-gradient-to-r from-red-400 via-pink-400 to-purple-400 opacity-20 blur-[100px] -left-48 -top-48"></div>
            <div class="absolute w-96 h-96 bg-gradient-to-r from-purple-400 via-indigo-400 to-blue-400 opacity-20 blur-[100px] -right-48 -bottom-48"></div>
            ...
            <div class="relative z-10">
              ...
              <div class="flex justify-center mb-6">
                <div class="relative">
                  <div class="absolute inset-0 bg-gradient-to-r from-red-400 to-pink-400 blur-xl opacity-50"></div>
                  <div class="relative w-20 h-20 bg-gradient-to-r from-red-400 to-pink-400 rounded-full flex items-center justify-center">
              ...
              <!-- Warning Message -->
              <div class="bg-red-500/10 backdrop-blur-sm border border-red-500/30 rounded-xl p-4 mb-6">
                <p class="text-white text-center">
                  <span class="font-semibold">¡Atención!</span> Al anular esta habitación también se anularán todos los consumos asociados a la visita.
                </p>
              ...
              <!-- Room Info -->
              <div v-if="habitacion" class="bg-white/10 backdrop-blur-sm border border-white/30 rounded-xl p-4 mb-6">
                <div class="flex items-center justify-between">
                  <span class="text-white/60 text-sm">Habitación</span>
                  <span class="text-white font-semibold">{{ habitacion.NombreHabitacion || habitacion.nombreHabitacion }}</span>
                </div>
              ...
              <div class="mb-6">
                ...
                <div class="flex items-center justify-between mt-2">
                  ...
                  <p class="text-white/40 text-sm ml-auto">
                    {{ motivo.length }}/500
                  </p>
                </div>
              </div>
