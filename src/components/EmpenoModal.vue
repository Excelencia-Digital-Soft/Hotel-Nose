            ...
            <div class="glass-card p-6 mb-4 border-b border-white/10">
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <div>
                    <h2 class="text-xl font-bold text-white mb-1">💎 Empeño</h2>
                    <p class="text-gray-300 text-sm">Registrar empeño de cliente</p>
                  </div>
                </div>
              ...
              <div class="space-y-4">
                ...
                <div>
                  <label class="flex items-center mb-3">
                    <i class="pi pi-file-edit text-blue-400 mr-2"></i>
                    <span class="text-white font-semibold">Descripción del Empeño</span>
                  ...
                  <textarea
                    ...
                    placeholder="Describe el artículo empeñado..."
                  ></textarea>
                ...
                <div>
                  <label class="flex items-center mb-3">
                    ...
                    <span class="text-white font-semibold">Monto del Empeño</span>
                    <span class="text-red-400 ml-1">*</span>
                  </label>
                  <input
                    type="number"
            ...
            <div class="glass-card p-6">
              <div class="flex gap-3">
                ...
                <button 
                  ...
                  :class="isFormValid 
                    ? 'bg-gradient-to-r from-blue-400 to-purple-400 hover:from-blue-500 hover:to-purple-500 text-white shadow-lg' 
...
// Define emits
const emit = defineEmits(['close', 'confirm-empeno'])
