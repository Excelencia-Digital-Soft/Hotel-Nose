    ...
    <Transition name="modal-outer" appear>
      <div
        ...
        <Transition name="modal-inner">
          <div class="relative w-full max-w-6xl h-[90vh] bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 rounded-2xl shadow-2xl border border-primary-500/20 flex flex-col overflow-hidden"
            @click.stop>
            
            <!-- Header mejorado -->
            <div class="relative px-6 py-4 bg-gradient-to-r from-primary-600/10 via-secondary-600/10 to-accent-600/10 border-b border-neutral-700/50 flex-shrink-0">
              <div class="flex items-center justify-between">
                ...
                <button 
                  ...
                  <span class="material-symbols-outlined group-hover:rotate-90 transition-transform duration-200">close</span>
                </button>
              </div>
            </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="relative">
                  ...
                  <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none mt-6">
                    <span class="material-symbols-outlined text-neutral-400 text-lg">expand_more</span>
                  </div>
                </div>
              </div>
            ...
            <div class="flex-1 min-h-0 flex flex-col">
              ...
              <div class="flex-1 overflow-y-auto px-6 py-4" style="min-height: 200px; max-height: calc(90vh - 400px);">
                
                <!-- Estado vacío mejorado -->
                <div v-if="filteredProductos.length === 0" class="flex flex-col items-center justify-center min-h-[300px] text-center">
                  <div class="w-16 h-16 rounded-full bg-neutral-700/50 flex items-center justify-center mb-4">
                    <span class="material-symbols-outlined text-neutral-400 text-2xl">inventory</span>
                  </div>
                  <h3 class="text-lg font-semibold text-white mb-2">No hay productos disponibles</h3>
                  ...
                  <button 
                    @click="keyword = ''; selectedCategory = null"
                ...
                <div v-else class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 pb-4">
                  <div 
                    ...
                    <div v-if="seleccionados.some(p => p.articuloId === producto.articuloId)"
                    ...
                    <!-- Imagen del producto -->
                    <div class="aspect-square bg-neutral-700/50 rounded-lg mb-3 overflow-hidden group-hover:scale-105 transition-transform duration-300">
                      <img 
                    ...
                    <!-- Info del producto -->
                    <div class="space-y-2">
                      <h3 class="font-semibold text-white text-sm leading-tight group-hover:text-primary-300 transition-colors line-clamp-2">
                    ...
                    <!-- Overlay de hover -->
                    <div class="absolute inset-0 bg-gradient-to-t from-primary-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl pointer-events-none"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div v-if="seleccionados.length > 0" class="border-t border-neutral-700/50 bg-neutral-800/30 flex-shrink-0">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-neutral-400">
                  ...
                  <span v-else>
                    ...
                    • Total: ${{ seleccionados.reduce((sum, item) => sum + (item.precio * item.cantidad), 0).toFixed(2) }}
                  </span>
                </div>
...
const filteredProductos = computed(() => {
  return productos.value.filter(producto => {
    const matchesCategory = !selectedCategory.value || 
      producto.categoriaID === selectedCategory.value.categoriaId;
