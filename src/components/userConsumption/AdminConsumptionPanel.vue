<template>
  <div class="space-y-6">
    ...
    <div class="glass-card p-6">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            <div class="relative">
              <input v-model="userSearchTerm" type="text" placeholder="Buscar por nombre de usuario o nombre..."
                class="glass-input w-full px-4 py-3 pr-10" autocomplete="off" autocorrect="off" autocapitalize="off"
                spellcheck="false" @input="searchUsers" @focus="showUserDropdown = true" />
              <i class="pi pi-search absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
            </div>

            <!-- User Dropdown -->
            <div v-if="showUserDropdown && filteredUsers.length > 0" class="glass-card max-h-48 overflow-y-auto">
            ...
            <div v-if="selectedUser" class="bg-blue-500/10 p-4 rounded-lg border border-blue-500/30">
              <div class="flex justify-between items-center">
                ...
                <button @click="clearUser" class="bg-red-500/20 hover:bg-red-500/30 p-2 rounded-full transition-colors">
          ...
          <div class="flex space-x-3">
            <button @click="fetchUserConsumption" :disabled="!selectedUser || loading"
            ...
            <button @click="fetchUserSummary" :disabled="!selectedUser || loading"
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-3">
            <button @click="fetchAllConsumption" :disabled="loading"
            ...
            <button @click="exportAllData" :disabled="!allConsumption || allConsumption.length === 0"
    ...
    <div v-if="showFilteredConsumption && selectedUser" class="glass-card p-6">
      <div class="flex items-center justify-between mb-6">
        ...
        <button @click="showFilteredConsumption = false"
      ...
      <!-- ✅ Caso con consumos -->
      <template v-if="filteredConsumptionByUser.length > 0">
        ...
        <div class="overflow-hidden rounded-lg">
          ...
          <div class="max-h-80 overflow-y-auto">
            <div v-for="consumption in filteredConsumptionByUser" :key="consumption.id"
        ...
        <div class="mt-6 flex justify-end">
          <button @click="exportUserData" class="glass-button py-2 px-4 text-white hover:bg-white/20 transition-all">
            <i class="pi pi-file-excel mr-2"></i>
      ...
      <template v-else>
        <div class="text-center py-10">
          ...
          <p class="text-gray-300 text-lg">Este usuario no tiene consumos</p>
        </div>
      </template>
    </div>
    ...
    <!-- Statistics Summary -->
    <div v-if="!showFilteredConsumption && allConsumption && allConsumption.length > 0" class="glass-card p-6">
    ...
    <div v-if="topUsers.length > 0" class="glass-card p-6">
      ...
      <div class="overflow-hidden rounded-lg">
        ...
        <div class="max-h-64 overflow-y-auto">
          <div v-for="(user, index) in topUsers" :key="user.userId"
            class="px-6 py-4 border-b border-white/5 hover:bg-white/5 transition-colors">
