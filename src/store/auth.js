    ...
    async login(credentials) {
      ...
      try {
        ...
        if (response.data.isSuccess) {
          ...
          this.errors = response.data.errors?.length > 0 ? response.data.errors : [response.data.message || 'Error en el login'];
    ...
    async register(userData) {
      ...
      try {
        ...
        if (response.data.isSuccess) {
          ...
          this.errors = response.data.errors?.length > 0 ? response.data.errors : [response.data.message || 'Error en el registro'];
    ...
    async changePassword(passwordData) {
      ...
      try {
        ...
        if (response.data.isSuccess) {
          ...
          this.errors = response.data.errors || [response.data.message || 'Error al cambiar contraseña'];
          return { success: false, errors: this.errors };
        }
      } catch (error) {
