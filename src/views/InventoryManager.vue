    ...
    <div class="glass-container mb-6 p-6 transform hover:scale-[1.02] transition-all duration-300">
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
        <div class="text-center lg:text-left">
          ...
          <p class="text-gray-300 text-lg">Controla y actualiza tu stock de manera fácil y eficiente 🎯</p>
        </div>
      ...
      <div class="flex items-center justify-between mb-6">
        <div class="flex items-center">
          ...
          <h3 class="text-xl font-bold text-white">
            {{ filteredInventory.length > 0 ? `📋 ${filteredInventory.length} productos en inventario` : '📦 Tu inventario' }}
          </h3>
        </div>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="space-y-3">
            ...
            <div class="flex space-x-2">
              <button
                @click="item.newStock = 0; markAsChanged(item)"
              ...
              <button
                @click="item.newStock = 10; markAsChanged(item)"
          ...
          <!-- Change Indicator -->
          <div v-if="hasItemChanged(item)" class="mt-3 p-2 bg-yellow-500/20 rounded-lg border border-yellow-500/30">
        ...
        <div class="glass-card max-w-md mx-auto p-8">
          <div class="mb-6">
            ...
            <p class="text-gray-300 mb-6">
              {{ keyword ? 'Intenta con otros términos de búsqueda o ajusta los filtros' : 'Parece que no hay productos en el inventario aún' }}
            </p>
          </div>
          
          <button
            v-if="keyword"
            @click="keyword = ''; stockFilter = 'all'"
    ...
    <div class="fixed bottom-6 right-6 flex flex-col space-y-3">
      ...
      <button
        ...
        class="bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 
               text-white font-bold py-3 px-6 rounded-full shadow-lg transform hover:scale-105 
